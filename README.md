<h1 align="center"> Projeto Final da disciplina de Sistemas Distribuídos</h1>
...
Observe que estamos sempre codificando e decodificando as mensagens aqui. A razão para isso é que só podemos enviar bytes e não strings. Portanto, sempre precisamos codificar mensagens (por exemplo, usando ASCII), quando as enviamos e decodificá-las, quando as recebemos.<br />
